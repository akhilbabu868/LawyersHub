...
public class Qualificationmaster implements Serializable {
    ...
    public Qualificationmaster(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Qualificationmaster)) {
            return false;
        }
        Qualificationmaster other = (Qualificationmaster) object;
    ...
    public String toString() {
        return "com.lawyershub.Model.Qualificationmaster[ id=" + id + " ]";
    }
