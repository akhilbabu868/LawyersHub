...
public class Packagemaster implements Serializable {
    ...
    public Packagemaster(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Packagemaster)) {
            return false;
        }
        Packagemaster other = (Packagemaster) object;
    ...
    public String toString() {
        return "com.lawyershub.Model.Packagemaster[ id=" + id + " ]";
    }
