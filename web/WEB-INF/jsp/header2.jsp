<%-- 
    Document   : header2
    Created on : 6 Feb, 2020, 1:23:36 PM
    Author     : ASUS
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="Userdashboard.do">View Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="searchlawyer.do">Search</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="buypkg.do">Buy Package</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="login.do">Log Out</a>
                </li>
            </ul>
        </nav>
    </body>
