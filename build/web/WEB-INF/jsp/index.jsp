	...
	<nav class="colorlib-nav" role="navigation">
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-md-2">
						<div id="colorlib-logo"><a href="index.html">Lawyers<span>Hub.</span></a></div>
					</div>
					<div class="col-md-10 text-right menu-1">
						<ul>
							...
							<li><a href="contact.html">Contact</a></li>
							 <li class="btn-cta"><a href="login.do"><span>Login /Sign Up</span></a></li> 
						</ul>
					</div>
				</div>
