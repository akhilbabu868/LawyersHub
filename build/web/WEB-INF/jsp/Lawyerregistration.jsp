<%-- 
    Document   : Lawyerregistration
    Created on : 6 Feb, 2020, 7:34:21 AM
    Author     : ASUS
--%>
    ...
    <body>  
        ...
        <div class="container">
            <div class="d-flex justify-content-center">
                <form action="javascript:submitForm();" method="POST"  id="LawyerRegistrationForm" enctype="multipart/form-data">
                    <div class="col text-center">
                    <h4>Lawyer Registration </h4>
                    </div>
                    <hr>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="js-example-placeholder-single  form-control" name="District"  id="District"></select>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="dob" class="col-sm-4 col-form-label">Qualification</label>
                    <div class="col-sm-8">
                        <select class="js-example-placeholder-single form-control" name="qualification" id="qualification"></select>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="dob" class="col-sm-4 col-form-label">Lawyer Type</label>
                    <div class="col-sm-8">
                        <select class="js-example-placeholder-single form-control" name="lawyertype" id="lawyertype"></select>
                    </div>
                </div>
                <div class="form-group row">
        ...
        <script src="customjs/lawyerregistration.js" type="text/javascript"></script>
