<%-- 
    ...
    Created on : 7 Feb, 2020, 7:17:14 AM
    Author     : ASUS
--%>
...
<html>
    <head>
        ...
        <script src="customjs/userdashboard.js" type="text/javascript"></script>
    </head>
        ...
        <div class="container main-secction">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 image-section">
                    <img src="images/demo/backcover.png" 
                </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 user-profil-part pull-left">
                        <div class="row ">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 user-detail-section1 text-center">
                                <button id="btnEdit"  data-toggle="modal" data-target="#profileEdit" class="btn btn-success btn-block follow">Edit Profile</button>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <textarea id="modaladdress" name="modaladdress" cols="28" rows="3" placeholder="address"></textarea>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group row">
...
<!--                                            <div class="modal-footer">
                    ...
                    <input type="hidden" value="${sessionScope.username }" id=" ">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="#buzz" role="tab" data-toggle="tab"><i class="fas fa-info-circle"></i>Package Info</a>
                                            </li>                                                
                                        </ul>
